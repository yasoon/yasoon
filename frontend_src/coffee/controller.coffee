...
(
  ...
  class Controller
    ...
    posts: (category, sort) ->
      ...
      LayoutView.contentRegion.$el
        .empty()
        .append(@postsPageView.render().$el)
    ...
    speakers: (category) ->
      ...
      LayoutView.contentRegion.$el
        .empty()
        .append(@speakersPageView.render().$el)
    ...
    speaker: (id, page) ->
      ...
      LayoutView.contentRegion.$el
        .empty()
        .append(@speakerPageView.render().$el)
    ...
    register: ->
      ...
      LayoutView.contentRegion.$el
        .empty()
        .append(@registerPageView.render().$el)
    ...
    author: (page) ->
      ...
      LayoutView.contentRegion.$el
        .empty()
        .append(@authorPageView.render().$el)
    ...
    undefinedRoute: ->
      ...
      LayoutView.contentRegion.$el
        .empty()
        .append(@errorPageView.render().$el)
