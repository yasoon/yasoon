    ...
    return WritePostPage = (function(_super) {
      ...
      WritePostPage.prototype.setPostData = function(data) {
        ...
        $(this.model.get('text')).each(function(iterator) {
          return text.push({
            'id': iterator,
            'text': $(this).find('.question_content').html(),
            'question': $(this).find('.questionTitle').html()
          });
        });
      ...
      WritePostPage.prototype.checkCategories = function() {
        return _.each(this.model.get('tags'), (function(_this) {
          return function(item) {
            return _this.$('input:checkbox').eq(item - 1).prop('checked', true);
          };
        })(this));
      };
...
define('text!templates/timelineAnswerTpl.htm',[],function () { return '<span>Пользователь <a href="#/speaker/<%= author_id %>/posts">%Username%</a> ответил на вопрос:</span>\r\n<h3>\r\n    <%= text %>\r\n    <span class="post-date"><%= _.getDateText(date) %></span>\r\n</h3>\r\n<div class="content">\r\n    <p><%= answerText %></p>\r\n</div>\r\n<div class="hr"></div>';});
