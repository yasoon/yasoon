...
define('text!templates/editProfileTpl.htm',[],function () { return '<% var reg = (typeof Window.config.regFrom === "undefined" || parseInt(Window.config.regFrom) === 0) ? true : false; %>\r\n<form role="form" class="register-form">\r\n    <% if (reg) { %>\r\n        <div class="page-header">\r\n            <h3>Редактировать профиль<br />\r\n                <small>Обновите свой профиль и пишите свои собственные истории</small>\r\n            </h3>\r\n        </div>\r\n        <div class="di form-group">\r\n            <input type="text" class="form-control" placeholder="Имя" id="name" name="name">\r\n            <span class="help-block"></span>\r\n        </div>\r\n        <div class="di form-group">\r\n            <input type="text" class="form-control" placeholder="Email" id="email" name="email">\r\n            <span class="help-block"></span>\r\n            <% if (typeof update === "undefined") { %>\r\n            <div class="di form-group">\r\n                <div class="hhdi">\r\n                    <input type="checkbox" id="subscribed" name="subscribed">\r\n                    <label for="subscribed">Подписаться на новости</label>\r\n                </div>\r\n            </div>\r\n            <% } %>\r\n        </div>\r\n        <div class="di form-group">\r\n            <input type="password" class="form-control" placeholder="Старый пароль" id="old_pasword" name="old_pasword">\r\n            <span class="help-block"></span>\r\n        </div>\r\n        <div class="di form-group">\r\n            <input type="password" class="form-control" placeholder="Новый пароль" id="new_pasword" name="new_pasword">\r\n            <span class="help-block"></span>\r\n        </div>\r\n    <% } %>\r\n        <div class="di form-group">\r\n            <input type="text" class="form-control" placeholder="Ваша работа" id="job" name="job">\r\n            <span class="help-block"></span>\r\n        </div>\r\n        <div class="di form-group">\r\n            <input type="text" class="form-control" placeholder="Интересы" id="interest" name="interest">\r\n            <span class="help-block"></span>\r\n        </div>\r\n        <div class="di form-group">\r\n            <input type="text" class="form-control" placeholder="Мечты" id="dream" name="dream">\r\n            <span class="help-block"></span>\r\n        </div>\r\n        <div class="di form-group">\r\n            <textarea placeholder="Короткая биография" maxlength="<%= maxLength %>" class="form-control" id="interviewCaption" name="interviewCaption"></textarea>\r\n            <span class="counter"><%= maxLength %></span>\r\n            <span class="help-block"></span>\r\n        </div>\r\n        <div class="hr di"></div>\r\n    <% if (reg) { %>\r\n        <div class="di form-group">\r\n            <input type="text" class="form-control" placeholder="Домашняя страница" id="homepage" name="homepage">\r\n        </div>\r\n        <div class="di form-group file_upload_block">\r\n            <div class="row">\r\n                <div class="col-sm-6">\r\n                    <label class="btn di btn_upload_img" id="upload" for="file">Загрузить фото</label>\r\n                </div>\r\n                <div class="col-sm-6">\r\n                    <div class="output text-right">\r\n                        <% if(avatarImg === null) { %>\r\n                        <img src="/frontend/img/noAvatar.jpg" alt="">\r\n                        <% } else { %>\r\n                        <img src="/upload/avatar/<%= avatarImg %>" alt="">\r\n                        <% } %>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <div class="row">\r\n            <div class="col-sm-12">\r\n                <button type="button" class="regbtn di btn js-update" data-count="2">В профиль</button>\r\n            </div>\r\n        </div>\r\n    <% } %>\r\n</form>';});

(function() {
  var __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  define('views/EditAuthorView',['text!templates/editProfileTpl.htm', 'views/RegisterPageView', 'fileupload', 'backbone', 'stickit', 'mediator'], function(editProfileTpl, RegisterPageView) {
    var UpdateProfile;
