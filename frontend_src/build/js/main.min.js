...
define('text!templates/speakerWritePostButtonTpl.htm',[],function () { return '<div class="write-post-button">\n    <select name="addNewHistory" id="select-new-history" class="btn" title="Написать историю">\n        <option value=\'\' disabled selected style=\'display:none;\'>Написать историю</option>\n        <option class=\'new-history-opt\' value="2"><%= _.getContent(10) %></option>\n        <option class=\'new-history-opt\' value="3"><%= _.getContent(12) %></option>    \n    </select>\n</div>';});
...
(function() {
  ...
  define('views/SpeakerWritePostButtonView',['text!templates/speakerWritePostButtonTpl.htm', 'backbone'], function(speakerPageTpl) {
    ...
    return SpeakerWritePostButtonView = (function(_super) {
      ...
      SpeakerWritePostButtonView.prototype.createHistory = function(event) {
        var page;
        event.preventDefault();
        page = $('#select-new-history').val();
        return window.location.href = '/#/post/new/' + page;
      };
