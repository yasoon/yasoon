...
define('text!templates/headerLogedTpl.htm',[],function () { return '<a href="#/author/<%= id %>">\r\n\t<% if(avatarImg === null) { %>\r\n\t\t<img src="/frontend/img/noAvatar.jpg" alt="">\r\n\t<% } else { %>\r\n\t\t<img src="/upload/avatar/<%= avatarImg %>" alt="">\r\n\t<% } %>\r\n\t<span>27</span>\r\n</a>\r\n<nav>\r\n\t<a href="#/author/posts/">Профиль</a>\r\n\t<a href="#/author/answers/">Вопросы (24)</a>\r\n\t<a href="#/author/timeline/">Лента (3)</a>\r\n\t<a href="#/logout/" id="js-logout">Выход</a>\r\n</nav>';});

(function() {
  var __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  define('views/HeaderLogedView',['text!templates/headerLogedTpl.htm', 'backbone'], function(headerLogedTpl) {
    var HeaderLogedView;
...
(function() {
  ...
  define('views/HeaderRegionView',['text!templates/headerTpl.htm', 'views/HeaderLoginView', 'views/HeaderLogedView', 'models/userModel', 'backbone'], function(headerTpl, HeaderLoginView, HeaderLogedView, userModel) {
...
(function() {
  ...
  define('views/NewPostPageView',['text!templates/writePostFormTpl.htm', 'views/PostCategories', 'views/PostInterviews', 'collections/CategoryCollection', 'collections/InterviewCollection', 'editor', 'backbone', 'stickit', 'mediator', 'bootstrap', 'jqueryUi'], function(writePostTpl, PostCategories, PostInterviews, CategoryCollection, InterviewCollection) {
    var WritePostPage;
...
(function() {
  define('views/QuestionFormView',['text!templates/answersListTpl.htm', 'backbone', 'stickit'], function(answersListTpl) {
    return Backbone.View.extend({
      ...
      setQuestion: function(event) {
        ...
        if (this.model.isValid()) {
          return $.post('/api/question/add', {
            ...
            return function(data) {
              return _this.model.set('savedQuestion', _this.model.get('question'));
            };
          })(this));
        } else {
          return this.showErrors(this.model.validationError);
      ...
      showErrors: function(errors) {
        return _.each(errors, (function(_this) {
          return function(error) {
            return _this.$("#" + error.name).closest('.form-group').removeClass('has-success').addClass('has-error').find('.help-block').text(error.message);
          };
        })(this));
      }
    });
...
(function() {
  define('collections/SpeakerAnswersCollection',['models/HistoryPagePostsModel', 'backbone'], function(HistoryPagePostsModel) {
    return Backbone.Collection.extend({
      model: HistoryPagePostsModel
    });
  });
...
(function() {
  define('models/QuestionModel',['backbone'], function() {
    return Backbone.Model.extend();
  });
...
(function() {
  define('views/RegisterPageView',['text!templates/registerTpl.htm', 'models/UserUpdateModel', 'fileupload', 'backbone', 'stickit', 'mediator'], function(registerTpl, UserUpdateModel) {
...
(function() {
  define('admin/views/InterviewsQuestionsView',['admin/views/InterviewQuestionView', 'backbone'], function(InterviewQuestionView) {
    return Backbone.View.extend({
      ...
      addOne: function(model) {
        var interview;
        interview = new InterviewQuestionView({
          model: model
        });
        return this.$el.append(interview.render().$el);
      }
    ...
    return Backbone.View.extend({
      ...
      saveInterview: function(event) {
        ...
        return $.post('/api/interview/save_interview', {
          ...
          return console.log(event, this.model, data);
        }, 'json');
      }
    });
  });
...
(function() {
  define('admin/views/InterviewsList',['admin/views/InterviewsView', 'admin/collections/InterviewsCollection', 'backbone'], function(InterviewsView, InterviewsCollection) {
    return Backbone.View.extend({
      initialize: function() {
        if (this.postsList == null) {
          this.postsList = new InterviewsView({
