...
(function() {
  define('views/PostAuthorModelView',['text!templates/speakerInfoTpl.htm', 'views/LoginPopUpView', 'models/PostAuthorModel', 'backbone', 'mediator'], function(speakerInfoTpl, LoginPopUpView, PostAuthorModel) {
    return Backbone.View.extend({
      subscriptions: {
