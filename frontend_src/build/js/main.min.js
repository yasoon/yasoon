...
(function() {
  define('views/PostAuthorModelView',['text!templates/speakerInfoTpl.htm', 'views/LoginPopUpView', 'backbone'], function(speakerInfoTpl, LoginPopUpView) {
    return Backbone.View.extend({
      tagName: 'aside',
      className: 'postinfo',
...
(function() {
  ...
  define('views/EditPostPageView',['text!templates/writePostFormTpl.htm', 'views/PostCategories', 'views/PostInterviews', 'views/NewPostPageView', 'collections/CategoryCollection', 'collections/InterviewCollection', 'editor', 'backbone', 'stickit', 'mediator', 'bootstrap'], function(writePostTpl, PostCategories, PostInterviews, NewPostPageView, CategoryCollection, InterviewCollection) {
    ...
    return WritePostPage = (function(_super) {
      ...
      WritePostPage.prototype.events = function() {
        return _.extend({}, WritePostPage.__super__.events.apply(this, arguments), {
      ...
      WritePostPage.prototype.initialize = function(options) {
        ...
        return $.post("/api/post/getPost", {
          ...
          return function(data) {
            ...
            text = [];
            $(_this.model.get('text')).each(function(iterator) {
              var value;
              value = [];
              value['id'] = iterator;
            ...
            _.each(_this.model.get('tags'), function(item) {
              return _this.$('input:checkbox').eq(item).prop('checked', true);
            });
            return _this.createInterviewsList(text);
          };
        })(this), 'json');
      };
...
(function() {
  define('views/SpeakerAnswerView',['text!templates/speakerAnswerTpl.htm', 'backbone'], function(speakerAnswerTpl) {
    return Backbone.View.extend({
      tagName: 'article',
      className: 'lim',
...
(function() {
  define('views/SpeakerAnswersCollectionView',['views/SpeakerAnswerView', 'backbone'], function(SpeakerAnswerView) {
    return Backbone.View.extend({
      tagName: 'section',
      answered: function() {
...
(function() {
  define('views/SpeakerContentView',['views/SpeakerPostsCollectionView', 'views/SpeakerAnswersCollectionView', 'views/EmptyView', 'collections/SpeakerPostsCollection', 'collections/SpeakerAnswersCollection', 'backbone'], function(SpeakerPostsCollectionView, SpeakerAnswersCollectionView, EmptyView, SpeakerPostsCollection, SpeakerAnswersCollection) {
    return Backbone.View.extend({
      tagName: 'section',
      className: 'lim',
      initialize: function(options) {
