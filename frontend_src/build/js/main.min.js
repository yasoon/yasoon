...
(function() {
  ...
  define('views/PostInterviews',['text!templates/postInterviewTpl.htm', 'views/InterviewView', 'views/ValidationView', 'backbone', 'stickit'], function(postInterviewTpl, InterviewView, ValidationView) {
    var PostInterviews;
    return PostInterviews = (function(_super) {
      ...
      PostInterviews.prototype.template = _.template(postInterviewTpl);
      ...
      PostInterviews.prototype.createFullText = function() {
