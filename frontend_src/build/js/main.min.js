...
(function() {
  ...
  define('views/HeaderLoggedView',['text!templates/headerLoggedTpl.htm', 'backbone', 'stickit'], function(headerLoggedTpl) {
    ...
    return HeaderLogedView = (function(_super) {
      ...
      HeaderLogedView.prototype.template = _.template(headerLoggedTpl);

      HeaderLogedView.prototype.bindings = {
        '#counter': 'timeline',
        '#answers': 'timeline_answers',
        '#posts': 'timeline_posts'
      };

      HeaderLogedView.prototype.initialize = function() {
        return $.get('/statistic/get_user_notification_count', (function(_this) {
          return function(data) {
