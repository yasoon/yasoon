...
define('text!templates/headerLoginTpl.htm',[],function () { return '<a href="#" id="login-trigger" data-bypass>Войти</a>';});

(function() {
  var __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  define('views/HeaderLoginView',['text!templates/headerLoginTpl.htm', 'backbone'], function(headerLoginTpl) {
    var HeaderLoginView;
...
(function() {
  define('views/HeaderRegionView',['text!templates/headerTpl.htm', 'views/LoginPopUpView', 'views/HeaderLoginView', 'views/HeaderLogedView', 'models/UserLoginModel', 'models/userModel', 'backbone'], function(headerTpl, LoginPopUpView, HeaderLoginView, HeaderLogedView, UserLoginModel, userModel) {
...
define('text!templates/postPageAuthorTpl.htm',[],function () { return '<div class="fixed-position-aside">\n\t<% if(avatarImg === null) { %>\n\t\t<img src="/frontend/img/noAvatar.jpg" alt="<%= name %>">\n\t<% } else { %>\n\t\t<img src="/upload/avatar/<%= avatarImg %>" alt="<%= name %>">\n\t<% } %>\n\t<h4><a href="#/speaker/<%= id %>/posts" class="usr-name"><%= name %></a></h4>\n\t<p class="u-description"><%= interviewCaption %></p>\n\t<div class="hr"></div>\n\t<div class="pub">\n\t\t<h4 class="p-label">published on</h4>\n\t\t<%= last_publish_date %>\n\t\t<div class="hr"></div>\n\t</div>\n\n\t<div class="media-hidden">\n\t\t<div class="inner">\n\t\t\t<div class="b-indent">Job:<br>\n\t\t\t\t<a href="#" class="t-under c-black"><%= job %></a> 5 years\n\t\t\t</div>\n\t\t\t<div class="b-indent">Interest:<br>\n\t\t\t\t<a href="#" class="t-under c-black"><%= interest %></a>\n\t\t\t</div>\n\t\t\t<div class="b-indent">Dream:<br>\n\t\t\t\t<a href="#" class="t-under c-black"><%= dream %></a>\n\t\t\t</div>\n\t\t\t<div class="hr"></div>\n\t\t\t<div class="d-box">\n\t\t\t\t<div>\n\t\t\t\t\t<p class="p-label">posts</p>\n\t\t\t\t\t<a href="#/speaker/<%= id %>/posts"><%= posts.length %></a>\n\t\t\t\t</div>\n\t\t\t\t<div>\n\t\t\t\t\t<p class="p-label">answers</p>\n\t\t\t\t\t<a href="#/speaker/<%= id %>/answers"><%= answers_count %></a>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div class="clearfix"></div>\n\t\t\t<div class="social">\n\t            <div class="hr"></div>\n\t\t\t\t<div class="social-links">\n\t\t\t\t\t<a href="#<%= self_link %>" class="ws"></a>\n\t\t\t\t\t<div class="clearfix"></div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div class="hr"></div>\n\t\t\t<div class="hdi">\n\t\t\t\t<a href="#" class="btn">Follow</a>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>';});

(function() {
  define('views/PostAuthorModelView',['text!templates/postPageAuthorTpl.htm', 'backbone'], function(postPageAuthorTpl) {
    return Backbone.View.extend({
      tagName: 'aside',
      className: 'postinfo',
...
(function() {
  define('views/PostCategories',['views/PostCategoryView', 'backbone'], function(PostCategoryView) {
    return Backbone.View.extend({
      ...
      render: function() {
        this.categoriesList = $('<ul class="list-unstyled"></ul>');
        this.collection.each((function(_this) {
          return function(category) {
            category.set(_this.data);
            return _this.addOne(category);
        ...
        this.$el.empty().append(this.categoriesList);
        this.$("a#" + this.data.category).addClass('active');
        return this;
      },
      addOne: function(category) {
...
define('text!templates/interviewTpl.htm',[],function () { return '<% var test = (typeof(text) !== "undefined") ? true : false; %>\r\n<a href="#" class="a-quertion <% if (test) { print(\'active\') } %>">\r\n\t<%= question %>\r\n</a>\r\n<div class="questionContent">\r\n\t<div class="di">\r\n\t\t<textarea class="editor" placeholder="Текст истории"><% if (test) { print(text) } %></textarea>\r\n\t</div>\r\n</div>';});

(function() {
  define('views/InterviewView',['text!templates/interviewTpl.htm', 'backbone'], function(interviewTpl) {
    return Backbone.View.extend({
      tagName: 'li',
...
(function() {
  define('views/PostInterviews',['views/InterviewView', 'backbone'], function(InterviewView) {
    return Backbone.View.extend({
      render: function() {
        this.interviewsList = $('<ul class="list-unstyled"></ul>');
        this.collection.each((function(_this) {
          return function(interview) {
            interview.set(_this.data);
            return _this.addOne(interview);
          };
        })(this));
        this.$el.empty().append(this.interviewsList);
        return this;
      },
      addOne: function(interview) {
        ...
        return this.interviewsList.append(interview.render().$el);
      }
    });
  });
...
(function() {
  define('models/InterviewModel',['backbone'], function() {
    return Backbone.Model.extend();
  });
...
(function() {
  define('views/NewPostPageView',['text!templates/writePostFormTpl.htm', 'views/PostCategories', 'views/PostInterviews', 'collections/CategoryCollection', 'collections/InterviewCollection', 'editor', 'backbone', 'stickit', 'mediator'], function(registerTpl, PostCategories, PostInterviews, CategoryCollection, InterviewCollection) {
    return Backbone.View.extend({
      events: function() {
        return {
...
define('text!templates/speakerInfoTpl.htm',[],function () { return '<div class="fixed-position-aside">\n\t<% if(avatarImg === null) { %>\n\t\t<img src="/frontend/img/noAvatar.jpg" alt="<%= name %>">\n\t<% } else { %>\n\t\t<img src="/upload/avatar/<%= avatarImg %>" alt="<%= name %>">\n\t<% } %>\n\t<h4>\n\t\t<a href="#/speaker/<%= id %>/posts" class="usr-name">\n\t\t\t<%= name %>\n\t\t</a>\n\t</h4>\n\t<p class="u-description">\n\t\t<%= interviewCaption %>\n\t</p>\n\t<div class="hr"></div>\n\t<div class="pub">\n\t\t<h4 class="p-label">published on</h4>\n\t\t<%= last_publish_date %>\n\t\t<div class="hr"></div>\n\t</div>\n\n\t<div class="media-hidden">\n\t\t<div class="inner">\n\t\t\t<div class="b-indent">Job:<br>\n\t\t\t\t<a href="#" class="t-under c-black">\n\t\t\t\t\t<%= job %>\n\t\t\t\t</a>\n\t\t\t</div>\n\t\t\t<div class="b-indent">Interest:<br>\n\t\t\t\t<a href="#" class="t-under c-black">\n\t\t\t\t\t<%= interest %>\n\t\t\t\t</a>\n\t\t\t</div>\n\t\t\t<div class="b-indent">Dream:<br>\n\t\t\t\t<a href="#" class="t-under c-black">\n\t\t\t\t\t<%= dream %>\n\t\t\t\t</a>\n\t\t\t</div>\n\t\t\t<div class="hr"></div>\n\t\t\t<div class="d-box">\n\t\t\t\t<div>\n\t\t\t\t\t<p class="p-label">posts</p>\n\t\t\t\t\t<% if (typeof(window.userId) !== "undefined" && window.userId !== id) {%>\n\t\t\t\t\t\t<a href="#/speaker/<%= id %>/posts">\n\t\t\t\t\t<% } else { %>\n\t\t\t\t\t\t<a href="#/author/posts">\n\t\t\t\t\t<% } %>\n\t\t\t\t\t\t<%= posts.length %>\n\t\t\t\t\t</a>\n\t\t\t\t</div>\n\t\t\t\t<div>\n\t\t\t\t\t<p class="p-label">answers</p>\n\t\t\t\t\t<% if (typeof(window.userId) !== "undefined" && window.userId !== id) {%>\n\t\t\t\t\t\t<a href="#/speaker/<%= id %>/answers">\n\t\t\t\t\t<% } else { %>\n\t\t\t\t\t\t<a href="#/author/answers">\n\t\t\t\t\t<% } %>\n\t\t\t\t\t\t<%= answers_count %>\n\t\t\t\t\t</a>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div class="clearfix"></div>\n\t\t\t<div class="social">\n        <div class="hr"></div>\n\t\t\t\t<div class="social-links">\n\t\t\t\t\t<a href="#<%= self_link %>" class="ws"></a>\n\t\t\t\t\t<div class="clearfix"></div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div class="hr"></div>\n\t\t\t<% if (typeof(window.userId) !== "undefined" && window.userId !== id) {%>\n\t\t\t\t<div class="hdi">\n\t\t\t\t\t<a href="#" class="btn">Follow</a>\n\t\t\t\t</div>\n\t\t\t<% } %>\n\t\t</div>\n\t</div>\n</div>';});

(function() {
  define('views/SpeakerInfoView',['text!templates/speakerInfoTpl.htm', 'backbone'], function(speakerInfoTpl) {
    return Backbone.View.extend({
      tagName: 'aside',
      className: 'postinfo',
...
(function() {
  define('models/SpeakerInfoModel',['backbone'], function() {
    return Backbone.Model.extend();
  });
...
(function() {
  ...
  define('views/SpeakerPageView',['views/SpeakerInfoView', 'views/SpeakerNavigationView', 'views/SpeakerContentView', 'models/SpeakerInfoModel', 'backbone'], function(SpeakerInfoView, SpeakerNavigationView, SpeakerContentView, SpeakerInfoModel) {
    var SpeakerPage;
...
(function() {
  define('router',['controller', 'backbone'], function(Controller) {
    var AppRouter;
