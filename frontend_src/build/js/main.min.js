...
define('text!templates/admin/postTpl.htm',[],function () { return '<div class="p-label">\r\n    <a href="#/speaker/<%= author_id %>/posts">\r\n        <%= author_name %>\r\n    </a>\r\n</div>\r\n<h2>\r\n    <a href="#/post/<%= id %>">\r\n        <%= caption %>\r\n    </a>\r\n    <a href="#/post/<%= id %>/edit" class="editable"></a>\r\n</h2>\r\n<div class="content">\r\n    <p>\r\n        <%= preview %>\r\n    </p>\r\n</div>\r\n<div class="row">\r\n    <div class="col-sm-6 text-right">\r\n        <button type="button" class="btn js-postOfTheDay">Назначить постом дня</button>\r\n    </div>\r\n    <div class="col-sm-6 text-left">\r\n        <button type="button" class="btn js-delete">Удалить пост</button>\r\n    </div>\r\n</div>\r\n<div class="hr"></div>';});

(function() {
  define('admin/PostsList',['text!templates/admin/postTpl.htm', 'backbone'], function(postTpl) {
    var PostsList;
    PostsList = (function() {
      var Collection, Model, View, Views, counter, list;
      ...
      Views = Backbone.View.extend({
        ...
        addOne: function(model) {
          ...
          return $('#posts').append(view.render().$el);
        }
      });
...
(function() {
  ...
  define('admin/AdminPageView',['text!templates/admin/adminMainPageTpl.htm', 'admin/AdminsList', 'admin/PostsList', 'backbone', 'bootstrap'], function(adminMainPageTpl, AdminsList, PostsList) {
    var AdminPageView;
    return AdminPageView = (function(_super) {
      ...
      AdminPageView.prototype.createPostsList = function() {
        return this.postsList = new PostsList();
      };
...
(function() {
  define('admin/controller',['views/LayoutView', 'admin/AdminPageView', 'backbone'], function(LayoutView, AdminPageView) {
    var Controller;
    Controller = (function() {
      function Controller() {}
