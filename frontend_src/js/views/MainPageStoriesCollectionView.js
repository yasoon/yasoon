(function() {
  ...
  define(['text!templates/postPreviewTpl.htm', 'views/PaginationView', 'views/PostPreview', 'backbone'], function(postPreviewTpl, PaginationView, PostPreview) {
    ...
    return PostsPreviewsCollection = (function(_super) {
      ...
      PostsPreviewsCollection.prototype.addOne = function(item) {
        ...
        return this.items.append(item.render().$el);
      };
