...
define('chaplin/application',['require', 'exports', 'module', 'underscore', 'backbone', 'chaplin/mediator', 'chaplin/dispatcher', 'chaplin/views/layout', 'chaplin/composer', 'chaplin/lib/router', 'chaplin/lib/event_broker'],
...
define('chaplin/mediator',['require', 'exports', 'module', 'backbone', 'chaplin/lib/support', 'chaplin/lib/utils'],
    function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;
...
// uRequire: start body of original nodejs module
        ...
        module.exports = Dispatcher = function() {
            ...
            Dispatcher.prototype.executeBeforeAction = function(controller, route, params, options) {
                var before, executeAction, promise, _this = this;
...
define('chaplin/composer',['require', 'exports', 'module', 'underscore', 'backbone', 'chaplin/lib/utils', 'chaplin/lib/composition', 'chaplin/lib/event_broker'],
    function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;
...
define('chaplin/views/layout',['require', 'exports', 'module', 'underscore', 'backbone', 'chaplin/lib/utils', 'chaplin/lib/event_broker', 'chaplin/views/view'],
    function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module
        "use strict";

        var $, Backbone, EventBroker, Layout, View, utils, _, __bind = function(fn, me) {
            return function() {
...
define('chaplin/views/view',['require', 'exports', 'module', 'underscore', 'backbone', 'chaplin/lib/utils', 'chaplin/lib/event_broker'],
    function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module
        "use strict";

        var $, Backbone, EventBroker, View, utils, _, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
            for (var key in parent) {
                if (__hasProp.call(parent, key)) child[key] = parent[key];
            }
            function ctor() {
        ...
        module.exports = View = function(_super) {
            ...
            View.prototype.delegate = function(eventName, second, third) {
                var bound, events, handler, list, selector, _this = this;
...
// uRequire: start body of original nodejs module
        ...
        module.exports = CollectionView = function(_super) {
            ...
            CollectionView.prototype.insertView = function(item, view, position, enableAnimation) {
                var $list, $next, $previous, $viewEl, children, childrenLength, included, insertInMiddle, isEnd, length, method, viewEl, _this = this;
...
define('chaplin/lib/router',['require', 'exports', 'module', 'underscore', 'backbone', 'chaplin/lib/event_broker', 'chaplin/lib/route', 'chaplin/lib/utils'],
    function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module
        "use strict";

        var Backbone, EventBroker, Route, Router, utils, _, __bind = function(fn, me) {
            return function() {
                return fn.apply(me, arguments);
            };
        };
...
define('chaplin/lib/composition',['require', 'exports', 'module', 'underscore', 'backbone', 'chaplin/lib/event_broker'],
    function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;

// uRequire: start body of original nodejs module
        "use strict";

        var Backbone, Composition, EventBroker, _, __hasProp = {}.hasOwnProperty;
...
// uRequire: start body of original nodejs module
        ...
        var support, utils, _, __slice = [].slice, __indexOf = [].indexOf || function(item) {
...
define('chaplin/lib/helpers',['require', 'exports', 'module', 'chaplin/mediator'],
    function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;
...
define('chaplin',['require', 'exports', 'module', 'chaplin/application', 'chaplin/mediator', 'chaplin/dispatcher', 'chaplin/controllers/controller', 'chaplin/composer', 'chaplin/lib/composition', 'chaplin/models/collection', 'chaplin/models/model', 'chaplin/views/layout', 'chaplin/views/view', 'chaplin/views/collection_view', 'chaplin/lib/route', 'chaplin/lib/router', 'chaplin/lib/delayer', 'chaplin/lib/event_broker', 'chaplin/lib/helpers', 'chaplin/lib/support', 'chaplin/lib/sync_machine', 'chaplin/lib/utils'],
    function (require, exports, module) {var isWeb = (typeof define === 'function' && define.amd), isNode = !isWeb;
