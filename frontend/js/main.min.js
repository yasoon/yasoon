  ...
  define('models/QuestionModel',['models/ValidateModel', 'backbone'], function(ValidateModel) {
    ...
    return QuestionModel = (function(_super) {
      ...
      QuestionModel.prototype.validate = function(attrs) {
        ...
        } else if (attrs.question === attrs.savedQuestion) {
          errors.push({
            name: 'question',
...
define('text!admin/templates/adminTpl.htm',[],function () { return '<article>\r\n    <h2><a href="/#speaker/<%= id %>/posts"><%= name %></a></h2>\r\n    <div class="content lic">E-mail: <%= email %></div>\r\n    <div class="content lic">Зарегистрировался: <%= date_reg %></div>\r\n    <div class="t-center">\r\n        <a href="#" class="btn deleteAdmin redBtn">Убрать из администраторов</a>\r\n        <a href="#" class="btn authorDelete">Удалить автора</a>\r\n        <b>Администратор</b>\r\n        <a href="#" class="btn setAdmin">Назначить администратором</a>\r\n    </div>\r\n    <div class="hr"></div>\r\n</article>';});

(function() {
  define('admin/views/AdminsList',['text!admin/templates/adminTpl.htm', 'backbone'], function(adminTpl) {
    var AdminsList;
    AdminsList = (function() {
      var Collection, Model, View, Views, list;
      ...
      Views = Backbone.View.extend({
        ...
        addOne: function(admin) {
          var Admin;
          Admin = new View({
            model: admin
          });
          return $('#adminsList').append(Admin.render().$el);
        }
      });
...
(function() {
  define('admin/views/PostView',['text!admin/templates/postTpl.htm', 'backbone'], function(postTpl) {
    return Backbone.View.extend({
      ...
      render: function() {
        this.$el.data('postId', this.model.get('id')).append(this.template(this.model.toJSON()));
        return this;
      }
    });
  });
...
(function() {
  define('admin/views/PostsView',['admin/views/PostView', 'backbone'], function(PostView) {
    return Backbone.View.extend({
      initialize: function() {
        this.collection.fetch();
        return this.listenTo(this.collection, 'add', this.addOne);
...
define('text!admin/templates/interviewTpl.htm',[],function () { return '<h2><a href="#" class="openInterview"><%= name %></a></h2>\r\n<div class="editBlock form-group">\r\n    <input type="text" value="<%= name %>" placeholder="Введите название интервью" class="form-control interviewName" />\r\n</div>\r\n<div class="interview_question_list">\r\n    <ul class="list-unstyled">\r\n        <% _.each(questions,function(question,indx){ %>\r\n        <li data-id="<%= question.id %>" class="input-group">\r\n            <input type="text" class="interview_question form-control" placeholder="Введите текст вопроса" value="<%= question.text %>" data-id="<%= question.id %>"/>\r\n            <span class="input-group-btn">\r\n                <button type="button" class="btn btn-default js-deleteQuestion">Удалить</button>\r\n            </span>\r\n        </li>\r\n        <% }); %>\r\n        <li class="input-group">\r\n            <input type="text" class="interview_question form-control" placeholder="Введите текст вопроса"/>\r\n            <span class="input-group-btn">\r\n                <button type="button" class="btn btn-default js-add">Добавить</button>\r\n            </span>\r\n        </li>\r\n    </ul>\r\n    <article class="text-center">\r\n        <div class="row">\r\n            <div class="col-sm-6 text-right">\r\n                <button type="button" class="btn js-save">Сохранить</button>\r\n            </div>\r\n            <div class="col-sm-6 text-left">\r\n                <button type="button" class="btn js-deleteInterview">Удалить</button>\r\n            </div>\r\n        </div>\r\n        <div class="interviewLink">\r\n            <p>\r\n                <b>Ссылка на интервью:</b>\r\n                <a href="/#/post/new/<%= id %>/" target="_blank">\r\n                    <%= window.location.origin+\'/#/post/new/\' + id + \'/\' %>\r\n                </a>\r\n            </p>\r\n        </div>\r\n    </article>\r\n</div>';});

(function() {
  define('admin/views/InterviewView',['text!admin/templates/interviewTpl.htm', 'backbone', 'stickit'], function(interviewTpl) {
    return Backbone.View.extend({
      tagName: 'article',
      className: 'interview',
      template: _.template(interviewTpl),
...
(function() {
  ...
  define('admin/views/AdminPageView',['text!admin/templates/adminMainPageTpl.htm', 'admin/views/AdminsList', 'admin/views/PostsList', 'admin/views/ContentsList', 'admin/views/InterviewsList', 'backbone', 'bootstrap'], function(adminMainPageTpl, AdminsList, PostsList, ContentsList, InterviewsList) {
    var AdminPageView;
