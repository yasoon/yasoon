...
(function() {
  ...
  define('admin/AdminPageView',['text!templates/AdminMainPageTpl.htm', 'admin/AdminsList', 'backbone', 'bootstrap'], function(AdminMainPageTpl, AdminsList) {
    var AdminPageView;
    return AdminPageView = (function(_super) {
      ...
      AdminPageView.prototype.createAdminsList = function() {
        return this.adminsList = new AdminsList();
      };
...
(function() {
  define('router',['controller', 'admin/controller', 'backbone', 'mediator'], function(Controller, AdminController) {
    var AppRouter;
