...
define('text!templates/timelineAnswerTpl.htm',[],function () { return '<span>Пользователь <a href="#/speaker/<%= author_id %>/posts"><%= ask_author_name %></a> ответил на вопрос:</span>\n<h3>\n    <%= text %>\n    <span class="post-date"><%= _.getDateText(date) %></span>\n</h3>\n<div class="content">\n    <p><%= answerText %></p>\n</div>\n<div class="hr"></div>';});
