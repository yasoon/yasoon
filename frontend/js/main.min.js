  ...
  define('views/LegoInterviewView',['text!templates/legoInterviewsTpl.htm', 'backbone', 'stickit'], function(legoInterviewsTpl) {
    ...
    return LegoInterviewView = (function(_super) {
      ...
      LegoInterviewView.prototype.openQuestion = function(event) {
        event.preventDefault();
        return $(event.currentTarget).next().slideToggle();
      };
...
define('text!admin/templates/legoTpl.htm',[],function () { return '<select id="lego-interviews">\n    \n</select>\n\n<select id="lego-questions">\n    \n</select>\n\n<div id="content-admin-view">\n\n</div>';});
...
(function() {
  ...
  define('admin/views/LegoView',['text!admin/templates/legoTpl.htm', 'text!admin/templates/oneInterviewTpl.htm', 'admin/views/LegoAnswersView', 'backbone', 'mediator'], function(legoTpl, oneInterviewTpl, LegoAnswersView) {
    var LegoView;
    return LegoView = (function(_super) {
      ...
      LegoView.prototype.getInterview = function() {
        ...
        return $.get('api/interview/questions/' + interviewId, (function(_this) {
          return function(data) {
