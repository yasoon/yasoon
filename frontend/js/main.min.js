...
(function() {
  ...
  define('views/SpeakerWritePostButtonView',['text!templates/speakerWritePostButtonTpl.htm', 'backbone'], function(speakerPageTpl) {
    ...
    return SpeakerWritePostButtonView = (function(_super) {
      ...
      SpeakerWritePostButtonView.prototype.className = 'lim';
...
(function() {
  ...
  define('views/SpeakerPageView',['views/PostAuthorModelView', 'views/SpeakerNavigationView', 'views/SpeakerContentView', 'views/SpeakerWritePostButtonView', 'models/PostAuthorModel', 'backbone'], function(PostAuthorModelView, SpeakerNavigationView, SpeakerContentView, SpeakerWritePostButtonView, PostAuthorModel) {
    var SpeakerPage;
...
(function() {
  ...
  define('admin/views/InterviewView',['text!admin/templates/interviewTpl.htm', 'admin/views/InterviewsQuestionsView', 'backbone', 'stickit'], function(interviewTpl, InterviewsQuestionsView) {
    ...
    return InterviewView = (function(_super) {
      ...
      InterviewView.prototype.onRender = function() {
        return this.createInterviewsList();
      };

      InterviewView.prototype.createInterviewsList = function() {
