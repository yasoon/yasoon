  ...
  define('views/LegoInterviewsView',['text!templates/legoAllInterviewsTpl.htm', 'backbone', 'stickit'], function(legoAllInterviewsTpl) {
    ...
    return LegoInterviewView = (function(_super) {
      ...
      LegoInterviewView.prototype.initialize = function() {
        return $.get("/api/interview/get_interviews_lego_all", {}, (function(_this) {
          return function(data) {
            return _this.checkErrors(data);
          };
        })(this));
      ...
      LegoInterviewView.prototype.setInterviews = function(data) {
        return this.$el.empty().append(this.template(_.extend({}, {
...
(function() {
  ...
  define('admin/views/LegoView',['text!admin/templates/legoTpl.htm', 'text!admin/templates/oneInterviewTpl.htm', 'text!admin/templates/imgTpl.htm', 'admin/views/LegoAnswersView', 'admin/collections/LegoCollection', 'backbone', 'mediator'], function(legoTpl, oneInterviewTpl, imageTpl, LegoAnswersView, LegoCollection) {
    var LegoView;
    return LegoView = (function(_super) {
      ...
      LegoView.prototype.imgTemplate = _.template(imageTpl);
      ...
      LegoView.prototype.setImageUploader = function(modelLego, interviewId) {
        return new AjaxUpload(this.$('#uploadImg')[0], {
          ...
          onComplete: function(file, data) {
            ...
            return $('.file_upload_block, header').find('img').attr('src', "/web/upload/interviews/" + ret.file_name);
          }
        });
      };
...
(function() {
  ...
  define('admin/views/AdminPageView',['text!admin/templates/adminMainPageTpl.htm', 'admin/views/PostsList', 'admin/views/ContentsList', 'admin/views/InterviewsList', 'admin/views/PeoplesList', 'admin/views/LegoView', 'backbone', 'bootstrap'], function(adminMainPageTpl, PostsList, ContentsList, InterviewsList, PeoplesList, LegoView) {
    var AdminPageView;
    return AdminPageView = (function(_super) {
      ...
      AdminPageView.prototype.createLegoView = function() {
        ...
        this.$('#lego').append(this.legoView.render().$el);
        return this;
      };
