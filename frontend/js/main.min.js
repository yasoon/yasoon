...
(function() {
  define('router',['controller', 'admin/controller', 'models/userModel', 'backbone', 'mediator', 'html5shiv'], function(Controller, AdminController, userModel) {
    var AppRouter;
