...
define('text!templates/historyStoriesTpl.htm',[],function () { return '<article class="cat-title">\n\t<h3><%= name %></h3>\n\t<p><%= _.getContent(67) %></p>\n\t<div class="hr"></div>\n</article>\n\n<nav class="navigate">\n\t<a href="#/posts/<%= category %>/dateSort/" class="<% if (sort === \'dateSort\') print(\'active\') %>">новые</a>\n\t<a href="#/posts/<%= category %>/rateSort/" class="<% if (sort === \'rateSort\') print(\'active\') %>">популярные</a>\n</nav>';});
