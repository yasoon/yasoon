    ...
    _.mixin({
      'getContent': function(id) {
        ...
        if (Window.config.content[id]) {
          return Window.config.content[id].text;
        } else {
...
define('text!templates/headerLoggedTpl.htm',[],function () { return '<a href="#/author/<%= id %>">\r\n\t<% if(avatarImg === null) { %>\r\n\t\t<img src="/frontend/img/noAvatar.jpg" alt="">\r\n\t<% } else { %>\r\n\t\t<img src="/upload/avatar/<%= avatarImg %>" alt="">\r\n\t<% } %>\r\n\t<span id="counter"></span>\r\n</a>\r\n<nav>\r\n\t<a href="#/author/posts/">Профиль</a>\r\n\t<a href="#/author/answers/">Вопросы (<span id="answers"></span>)</a>\r\n\t<a href="#/timeline/">Лента (<span id="posts"></span>)</a>\r\n\t<a href="#/logout/" id="js-logout">Выход</a>\r\n</nav>';});
...
define('text!templates/emptyPageTpl.htm',[],function () { return '<p class="text-center"><%= message %></p>';});
...
define('text!templates/postPreviewTpl.htm',[],function () { return '<% var author = (typeof(authorId) !== "undefined") ? authorId : authorid %>\n<div class="p-label">\n    <a href="#/speaker/<%= author %>/posts">\n        <% if (typeof(authorName) !== "undefined") { %>\n        <%= authorName %>\n        <% } else { %>\n        <%= autorName %>\n        <% } %>\n    </a>\n</div>\n<h2>\n    <a href="#/post/<%= id %>">\n        <% if (typeof(caption) !== "undefined") { %>\n        <%= caption %>\n        <% } else { %>\n        <%= title %>\n        <% } %>\n    </a>\n    <% if (author === Window.config.userId) { %>\n    <a href="#/post/<%= id %>/edit" class="editable"></a>\n    <% } %>\n</h2>\n<div class="content">\n    <p>\n        <% if (typeof(preview) !== "undefined") { %>\n        <%= preview %>\n        <% } else { %>\n        <%= description %>\n        <% } %>\n\n    </p>\n</div>\n<div class="hr"></div>';});
...
define('text!templates/categoriesListTpl.htm',[],function () { return '<div class="di">\n  <input type="text" class="search" placeholder="Search">\n</div>\n<div class="p-label di">\n  <b>\n    Categories\n  </b>\n</div>\n<nav class="nav-cat">\n\t<ul class="list-unstyled">\n\t\t<li>\n\t\t\t<a href="#/<%= page %>/0/<%= sort %>" id="0">\n        Все\n      </a>\n\t\t</li>\n\t</ul>\n</nav>';});
...
define('text!templates/historyStoriesTpl.htm',[],function () { return '<article class="lim cat-title">\n\t<h3><%= name %></h3>\n\t<p><%= description %></p>\n\t<div class="hr"></div>\n</article>\n\n<nav class="navigate">\n\t<a href="#/posts/<%= category %>/dateSort/" class="<% if (sort === \'dateSort\') print(\'active\') %>">By post add</a>\n\t<a href="#/posts/<%= category %>/rateSort/" class="<% if (sort === \'rateSort\') print(\'active\') %>">By post rate</a>\n</nav>';});
...
define('text!templates/speakerInfoTpl.htm',[],function () { return '<% var check = (Window.config.userId === id) ? false : true  %>\r\n<% var path = (check) ? "#/author" : "#/speaker/" + id %>\r\n<% if (typeof self_link === \'string\' && self_link.match(/facebook.com/g)){\r\n    var linkClass = \'wf\'\r\n} else if (typeof self_link === \'string\' && self_link.match(/vk.com/g)) {\r\n    var linkClass = \'wb\'\r\n} else {\r\n    var linkClass = \'ws\'\r\n}%>\r\n<div class="fixed-position-aside">\r\n    <% if(avatarImg === null) { %>\r\n        <img src="/frontend/img/noAvatar.jpg" alt="<%= name %>">\r\n    <% } else { %>\r\n        <img src="/upload/avatar/<%= avatarImg %>" alt="<%= name %>">\r\n    <% } %>\r\n    <h4>\r\n        <% if (check) { %>\r\n            <a href="<%= path %>/posts/" class="usr-name">\r\n                <%= name %>\r\n            </a>\r\n        <% } else { %>\r\n            <%= name %>\r\n            <a href="#/author/edit/" class="editable"></a>\r\n        <% } %>\r\n    </h4>\r\n    <p class="u-description">\r\n        <%= interviewCaption %>\r\n    </p>\r\n    <div class="hr"></div>\r\n    <div class="pub">\r\n        <h4 class="p-label">Последние обновления</h4>\r\n            <%= _.getDateText(last_publish_date) %>\r\n        <div class="hr"></div>\r\n    </div>\r\n\r\n    <div class="media-hidden">\r\n        <div class="inner">\r\n            <div class="b-indent">Job:<br>\r\n                <a href="#" class="t-under c-black">\r\n                    <%= job %>\r\n                </a>\r\n            </div>\r\n            <div class="b-indent">Interest:<br>\r\n                <a href="#" class="t-under c-black">\r\n                    <%= interest %>\r\n                </a>\r\n            </div>\r\n            <div class="b-indent">Dream:<br>\r\n                <a href="#" class="t-under c-black">\r\n                    <%= dream %>\r\n                </a>\r\n            </div>\r\n            <div class="hr"></div>\r\n            <div class="d-box">\r\n                <div>\r\n                    <p class="p-label">posts</p>\r\n                    <a href="<%= path %>/posts/">\r\n                        <%= posts.length %>\r\n                    </a>\r\n                </div>\r\n                <div>\r\n                    <p class="p-label">answers</p>\r\n                    <a href="<%= path %>/answers/">\r\n                        <%= answers_count %>\r\n                    </a>\r\n                </div>\r\n            </div>\r\n            <% if (self_link) { %>\r\n            <div class="social">\r\n                <div class="hr"></div>\r\n                <div class="social-links">\r\n                    <% if (self_link.substr(0, 4) === \'http\') { %>\r\n                    <a href="<%= self_link %>" class="<%= linkClass %>"></a>\r\n                    <% } else { %>\r\n                    <a href="http://<%= self_link %>" class="<%= linkClass %>"></a>\r\n                    <% } %>\r\n                    <div class="clearfix"></div>\r\n                </div>\r\n            </div>\r\n            <% } %>\r\n            <div class="clearfix"></div>\r\n            <div class="hr"></div>\r\n            <% if (Window.config.userId !== id) { %>\r\n                <div class="hdi">\r\n                    <button type="button" class="btn js-follow">Follow</button>\r\n                </div>\r\n            <% } %>\r\n        </div>\r\n    </div>\r\n</div>';});
...
(function() {
  define('views/PostAuthorModelView',['text!templates/speakerInfoTpl.htm', 'views/LoginPopUpView', 'backbone', 'mediator'], function(speakerInfoTpl, LoginPopUpView) {
    return Backbone.View.extend({
      subscriptions: {
...
(function() {
  define('views/PostPageView',['views/PostPageModelView', 'views/PostAuthorModelView', 'models/PostPageModel', 'models/PostAuthorModel', 'backbone'], function(PostPageModelView, PostAuthorModelView, PostPageModel, PostAuthorModel) {
    return Backbone.View.extend({
      tagName: 'section',
      className: 'page-layout',
      events: function() {
...
define('text!templates/writePostFormTpl.htm',[],function () { return '<form role="form">\n\t<div class="post-edit">\n\t\t<article>\n\t\t\t<h3 class="t-center">\n\t\t\t\tНапишите свою историю\n\t\t\t</h3>\n\t\t\t<div class="hr"></div>\n\t\t</article>\n\t\t\n\t\t<div class="di form-group">\n\t\t\t<input type="text" class="form-control" name="title" id="title" placeholder="Заголовок истории">\n\t\t\t<p class="help-block"></p>\n\t\t</div>\n\t\t\n\t\t<div class="di panel-group" id="collapse">\n\t\t\t<div class="panel panel-default">\n\t\t\t\t<div class="panel-heading">\n\t\t\t\t\t<h4 class="panel-title">\n\t\t\t\t\t\t<a data-toggle="collapse" data-parent="#collapse" href="#categoryList">\n\t\t\t\t\t\t\tКатегории: <span class="categoryHeading"></span>\n\t\t\t\t\t\t</a>\n\t\t\t\t\t</h4>\n\t\t\t\t</div>\n\t\t\t\t<div id="categoryList" class="panel-collapse collapse">\n\t\t\t\t\t<!-- categoryList -->\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\n\t\t<div class="di form-group">\n\t\t\t<textarea class="description"  name="description" id="description" placeholder="Краткое описание истории" maxlength="<%= maxLength %>"></textarea>\n\t\t\t<p class="help-block"></p>\n\t\t\t<span class="counter">\n\t\t\t\t<%= maxLength %>\n\t\t\t</span>\n\t\t</div>\n\n\t\t<div id="questionsList" class="sortable"></div>\n\t\t\n\t\t<div class="di t-center buttons_area">\n\t\t\t<div class="row">\n\t\t\t\t<div class="col-sm-6 text-right">\n\t\t\t\t\t<button type="submit" class="btn">Опубликовать</a>\n\t\t\t\t</div>\n\t\t\t\t<div class="col-sm-6 text-left">\n\t\t\t\t\t<button type="button" class="btn js-delete">Удалить</a>\n\t\t\t\t</div>\n\t\t\t\t<div class="col-sm-6 text-left">\n\t\t\t\t\t<button type="reset" class="btn">Отмена</a>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</form>';});
...
(function() {
  ...
  define('views/PostCategories',['views/PostCategoryView', 'backbone', 'mediator'], function(PostCategoryView) {
    ...
    return PostCategoriesList = (function(_super) {
      ...
      PostCategoriesList.prototype.subscriptions = {
      ...
      PostCategoriesList.prototype.checkedCategories = function() {
        var blocked, categories, checked;
        checked = this.collection.where({
          'checked': true
        });
        categories = _.map(checked, function(model) {
          return model.get('id');
        });
        blocked = categories.length > 2 ? true : false;
        this.$('input:checkbox:not(:checked)').prop('disabled', blocked);
        return categories;
      };

      PostCategoriesList.prototype.checkedCategoriesNames = function() {
        var checked, namesList;
        checked = this.collection.where({
          'checked': true
        });
        namesList = _.map(checked, function(model) {
...
(function() {
  define('views/PostInterviews',['text!templates/postInterviewTpl.htm', 'views/InterviewView', 'backbone', 'stickit'], function(postInterviewTpl, InterviewView) {
    return Backbone.View.extend({
      tagName: 'ul',
      ...
      render: function() {
        this.collection.each((function(_this) {
          return function(interview, iterator) {
            ...
            return _this.addOne(interview);
          };
        })(this));
        return this;
      },
      addOne: function(interview) {
      ...
      createFullText: function() {
        ...
        _.each(this.collection.models, (function(_this) {
          return function(model, iterator) {
            var data;
            if (!model.isValid()) {
              _this.hasErrors = true;
              data = _.extend(model.validationError[0], {
                id: iterator
              });
              return _this.showErrors(data);
            } else {
              return fullTextContainer.append(_this.template(model.toJSON()));
            }
          };
        })(this));
        if (!this.hasErrors) {
      ...
      showErrors: function(error) {
        return this.$('.redactor_box').eq(error.id).closest('.form-group').removeClass('has-success').addClass('has-error').find('.help-block').text(error.message);
      },
      hideErrors: function() {
        return this.$('.form-group').removeClass('has-error').addClass('has-success').find('.help-block').text('');
      }
...
(function() {
  ...
  define('views/EditPostPageView',['text!templates/writePostFormTpl.htm', 'views/PostCategories', 'views/PostInterviews', 'views/NewPostPageView', 'collections/CategoryCollection', 'collections/InterviewCollection', 'editor', 'backbone', 'stickit', 'mediator', 'bootstrap'], function(writePostTpl, PostCategories, PostInterviews, NewPostPageView, CategoryCollection, InterviewCollection) {
    ...
    return WritePostPage = (function(_super) {
      ...
      WritePostPage.prototype.initialize = function(options) {
        this.options = options || {};
        WritePostPage.__super__.initialize.apply(this, arguments);
        return $.post("/api/post/getPost", {
          postid: this.options.id
        }, (function(_this) {
          return function(data) {
      ...
      WritePostPage.prototype.setPostData = function(data) {
        ...
        this.model.set(data);
        text = [];
        $(this.model.get('text')).each(function(iterator) {
          var value;
          value = [];
          value['id'] = iterator;
          value['text'] = $(this).find('.question_content').text();
          value['question'] = $(this).find('.questionTitle').text();
          return text.push(value);
        });
        _.each(this.model.get('tags'), (function(_this) {
          return function(item) {
            return _this.$('input:checkbox').eq(item).prop('checked', true);
          };
        })(this));
        return this.createInterviewsList(text);
      };

      WritePostPage.prototype.createInterviewsList = function(data) {
        ...
        return this.$('.editor').redactor('sync');
      };

      WritePostPage.prototype.deletePost = function(event) {
        event.preventDefault();
...
define('text!templates/speakersStoriesTpl.htm',[],function () { return '<article class="lim cat-title">\n\t<h3>\n    <%= name %>\n  </h3>\n\t<p>\n    <%= description %>\n  </p>\n</article>\n\n<section class="speakers items-list"></section>\n\n<article class="bottom-toolbar text-center">\n  <button class="btn downloadMore">More speakers</button>\n</article>';});


define('text!templates/speakerPreviewTpl.htm',[],function () { return '<% var path = (Window.config.userId === id) ? "#/author" : "#/speaker/" + id %>\n<div class="speaker-avatar">\n\t<a href="<%= path %>/posts">\n\t\t<% if(avatarImg === null) { %>\n\t\t\t<img src="/frontend/img/noAvatar.jpg" alt="" class="usr-ic" alt="<%= name %>">\n\t\t<% } else { %>\n\t\t\t<img src="/upload/avatar/<%= avatarImg %>" class="usr-ic" alt="<%= name %>">\n\t\t<% } %>\n\t</a>\n</div>\n<div class="speaker-info">\n\t<h4 class="p-label">\n\t\t<span>Posts <a href="<%= path %>/posts" class="green"><%= posts_count %></a></span>\n        <span>&nbsp;&nbsp;&nbsp;</span>\n\t\t<span>Rate <a class="green"><%= likes_count %></a></span>\n\t</h4>\n\t<h2>\n\t\t<a href="<%= path %>/posts">\n\t\t\t<%= name %>\n\t\t</a>\n        <%= _.getDateText(last_publish_date) %>\n\t</h2>\n\t<div class="content lic">\n\t\t<%= interviewCaption %>\n\t</div>\n</div>\n<div class="hr"></div>';});
...
define('text!templates/speakerPageTpl.htm',[],function () { return '<nav class="navigate">\n\t<a href="#/speaker/<%= id %>/posts" class="<% if (page === \'posts\' || page === \'\') print(\'active\') %>">Stories</a>\n\t<a href="#/speaker/<%= id %>/answers" class="<% if (page === \'answers\') print(\'active\') %>">Answers</a>\n</nav>';});
...
define('text!templates/speakerAnswerTpl.htm',[],function () { return '<% if (hasAnswer) { %>\n\t<div class="p-label small">\n\t\t<b>\n\t\t\t<span class="green">\n\t\t\t\t<a href="#/speaker/<%= ask_authorId %>/posts">\n\t\t\t\t\t<%= ask_authorName %>, <%= ask_authorProf %>\n\t\t\t\t</a>\n\t\t\t</span> спросил(а)\n\t\t</b>\n\t</div>\n\t<h3>\n\t\t<%= questionText %>\n\t\t<span class="post-date">\n            <%= publishDate %>\n        </span>\n\t</h3>\n\t<div class="content">\n\t\t<p>\n            <%= questionAnswerText %>\n        </p>\n\t</div>\n\t<div class="hr"></div>\n<% } else if (typeof author !== "undefined") { %>\n    <div class="p-label small">\n        <b>\n            <span class="green">\n                <a href="#/speaker/<%= ask_authorId %>/posts">\n                    <%= ask_authorName %>, <%= ask_authorProf %>\n                </a>\n            </span> спросил(а)\n        </b>\n    </div>\n    <h3>\n        <%= questionText %>\n        <span class="post-date">\n            <%= publishDate %>\n        </span>\n    </h3>\n    <div class="content">\n        <form role="form">\n            <div class="form-group">\n                <textarea class="form-control" name="questionAnswerText" id="questionAnswerText" rows="3"></textarea>\n                <p class="help-block"></p>\n            </div>\n            <button class="btn" type="submit">Ответить</button>\n            <button class="btn js-delete" type="button">Удалить</button>\n        </form>\n    </div>\n    <div class="hr"></div>\n<% } else { %>\n\t<div style="margin-top: -20px;"></div>\n<% } %>';});

(function() {
  var __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  define('views/SpeakerAnswerView',['text!templates/speakerAnswerTpl.htm', 'views/ValidationView', 'backbone', 'mediator', 'stickit'], function(speakerAnswerTpl, ValidationView) {
...
(function() {
  define('views/SpeakerAnswersCollectionView',['views/SpeakerAnswerView', 'backbone', 'mediator'], function(SpeakerAnswerView) {
    return Backbone.View.extend({
      initialize: function(options) {
        return this.options = options || {};
      },
...
(function() {
  ...
  define('views/QuestionFormView',['text!templates/answersListTpl.htm', 'views/ValidationView', 'backbone', 'stickit'], function(answersListTpl, ValidationView) {
        ...
        if (this.model.isValid()) {
          return $.post('/api/question/add', {
            ...
            return function(data) {
              ...
              return _this.$(event.currentTarget).find('textarea').val('').closest('section').find('.answers').text(_.getContent(66));
            };
          })(this));
        } else {
          return this.showErrors(this.model.validationError);
...
(function() {
  ...
  define('views/SpeakerPageView',['views/PostAuthorModelView', 'views/SpeakerNavigationView', 'views/SpeakerContentView', 'models/PostAuthorModel', 'backbone'], function(PostAuthorModelView, SpeakerNavigationView, SpeakerContentView, PostAuthorModel) {
    var SpeakerPage;
...
define('text!templates/registerTpl.htm',[],function () { return '<% var reg = (typeof Window.config.regFrom === "undefined" || parseInt(Window.config.regFrom) === 0) ? true : false; %>\r\n<form role="form" class="register-form">\r\n    <% if (reg) { %>\r\n        <fieldset>\r\n            <div class="page-header">\r\n                <h3>Регистрация<br />\r\n                    <small>Создайте свой профиль и пишите свои собственные истории</small>\r\n                </h3>\r\n            </div>\r\n            <div class="di form-group">\r\n                <input type="text" class="form-control" placeholder="Имя" id="name" name="name">\r\n                <span class="help-block"></span>\r\n            </div>\r\n            <div class="di form-group">\r\n                <input type="text" class="form-control" placeholder="Email" id="email" name="email">\r\n                <span class="help-block"></span>\r\n                <% if (typeof update === "undefined") { %>\r\n                    <div class="di form-group">\r\n                        <div class="hhdi">\r\n                            <input type="checkbox" id="subscribed" name="subscribed">\r\n                            <label for="subscribed">Подписаться на новости</label>\r\n                        </div>\r\n                    </div>\r\n                <% } %>\r\n            </div>\r\n            <% if (typeof update === "undefined") { %>\r\n                <div class="di form-group">\r\n                    <input type="password" class="form-control" placeholder="Пароль" id="password" name="password">\r\n                    <span class="help-block"></span>\r\n                </div>\r\n            <% } else { %>\r\n                <div class="di form-group">\r\n                    <input type="password" class="form-control" placeholder="Старый пароль" id="old_pasword" name="old_pasword">\r\n                    <span class="help-block"></span>\r\n                </div>\r\n                <div class="di form-group">\r\n                    <input type="password" class="form-control" placeholder="Новый пароль" id="new_pasword" name="new_pasword">\r\n                    <span class="help-block"></span>\r\n                </div>\r\n            <% } %>\r\n            <% if (typeof update === "undefined") { %>\r\n                <button type="button" class="regbtn di btn js-register" data-count="0">Зарегистрироваться!</button>\r\n            <% } else { %>\r\n                <button type="button" class="regbtn di btn nav next" data-count="0">Вперед</button>\r\n            <% } %>\r\n        </fieldset>\r\n    <% } %>\r\n    <fieldset>\r\n        <div class="page-header">\r\n            <h3>Регистрация<br />\r\n                <small>Здесь вы можете выбрать вашу профессию, интересы и мечты о будущей работе</small>\r\n            </h3>\r\n        </div>\r\n        <div class="di form-group">\r\n            <input type="text" class="form-control" placeholder="Ваша работа" id="job" name="job">\r\n            <span class="help-block"></span>\r\n        </div>\r\n        <div class="di form-group">\r\n            <input type="text" class="form-control" placeholder="Интересы" id="interest" name="interest">\r\n            <span class="help-block"></span>\r\n        </div>\r\n        <div class="di form-group">\r\n            <input type="text" class="form-control" placeholder="Мечты" id="dream" name="dream">\r\n            <span class="help-block"></span>\r\n        </div>\r\n        <div class="di form-group">\r\n            <textarea placeholder="Короткая биография" maxlength="<%= maxLength %>" class="form-control" id="interviewCaption" name="interviewCaption"></textarea>\r\n            <span class="counter"><%= maxLength %></span>\r\n            <span class="help-block"></span>\r\n        </div>\r\n        <div class="hr di"></div>\r\n        <% if (reg) { %>\r\n            <div class="row">\r\n                <div class="col-sm-6">\r\n                    <button type="button" class="regbtn di btn nav prev" data-count="1">Вернуться назад</button>\r\n                </div>\r\n                <div class="col-sm-6">\r\n                    <button type="button" class="regbtn di btn nav next" data-count="1">Вперед</button>\r\n                </div>\r\n            </div>\r\n        <% } else { %>\r\n            <div class="row">\r\n                <div class="col-sm-12">\r\n                    <button type="button" class="regbtn di btn js-update" data-count="1">Сохранить</button>\r\n                </div>\r\n            </div>\r\n        <% } %>\r\n    </fieldset>\r\n    <% if (reg) { %>\r\n        <fieldset>\r\n            <div class="page-header">\r\n                <h3>Регистрация<br />\r\n                    <small>Здесь вы можете добавить фото и личную страницу</small>\r\n                </h3>\r\n            </div>\r\n            <div class="di form-group">\r\n                <input type="text" class="form-control" placeholder="Домашняя страница" id="homepage" name="homepage">\r\n            </div>\r\n            <div class="di form-group file_upload_block">\r\n                <div class="row">\r\n                    <div class="col-sm-6">\r\n                        <label class="btn di btn_upload_img" id="upload" for="file">Загрузить фото</label>\r\n                    </div>\r\n                    <div class="col-sm-6">\r\n                        <div class="output text-right">\r\n                            <img src="/frontend/img/noAvatar.jpg" width="150" alt="">\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n            <div class="row">\r\n                <div class="col-sm-6">\r\n                    <button type="button" class="regbtn di btn nav prev" data-count="2">Вернуться назад</button>\r\n                </div>\r\n                <div class="col-sm-6">\r\n                    <button type="button" class="regbtn di btn js-update" data-count="2">В профиль</button>\r\n                </div>\r\n            </div>\r\n        </fieldset>\r\n    <% } %>\r\n</form>';});
...
(function() {
  ...
  define('models/UserUpdateModel',["models/UserRegisterModel", "backbone"], function(UserRegisterModel) {
    var UserUpdateModel;
...
define('text!templates/authorPageTpl.htm',[],function () { return '<nav class="navigate">\n\t<a href="#/author/posts" id="posts">Stories</a>\n\t<a href="#/author/answers" id="answers">Answers</a>\n</nav>\n\n<% if (page === \'posts\') { %>\n  <article class="lim cat-title">\n    <div class="content">\n      <p>\n        <a href="#/post/new" class="btn">\n          Write a new post\n        </a>\n      </p>\n    </div>\n    <div class="hr"></div>\n  </article>\n<% } %>';});

(function() {
  define('views/AuthorNavigationView',['text!templates/authorPageTpl.htm', 'backbone'], function(authorPageTpl) {
    return Backbone.View.extend({
      tagName: 'section',
      className: 'lim',
...
(function() {
  ...
  define('views/AuthorPageView',['views/SpeakerPageView', 'views/AuthorNavigationView', 'backbone'], function(SpeakerPageView, AuthorNavigationView) {
    var AuthorPage;
...
(function() {
  ...
  define('views/EditAuthorView',['text!templates/registerTpl.htm', 'views/RegisterPageView', 'fileupload', 'backbone', 'stickit', 'mediator'], function(registerTpl, RegisterPageView) {
    var Register;
    return Register = (function(_super) {
      __extends(Register, _super);
      ...
      Register.prototype.initialize = function() {
        ...
        this.model.fetch();
        return this.model.set('update', true);
      };
...
define('text!templates/timelinePostTpl.htm',[],function () { return '<div class="row">\r\n    <div class="col-sm-2">\r\n        <% if(avatarImg === null) { %>\r\n        <img src="/frontend/img/noAvatar.jpg" alt="<%= name %>" width="100" height="100" class="img-circle">\r\n        <% } else { %>\r\n        <img src="/upload/avatar/<%= avatarImg %>" alt="<%= name %>" width="100" height="100" class="img-circle">\r\n        <% } %>\r\n    </div>\r\n    <div class="col-sm-10">\r\n        <h4>\r\n            <a href="#/speaker/<%= authorId %>/posts" class="p-label">\r\n                <%= authorName %>\r\n            </a>\r\n        </h4>\r\n        <h2>\r\n            <a href="#/post/<%= id %>"><%= title %></a>\r\n            <span class="post-date"><%= _.getDateText(publishDate) %></span>\r\n        </h2>\r\n        <div class="content lic">\r\n            <p><%= description %></p>\r\n        </div>\r\n    </div>\r\n</div>\r\n<div class="hr"></div>\r\n';});
...
define('text!templates/timelineAnswerTpl.htm',[],function () { return '<h3>\r\n    <%= text %>\r\n    <span class="post-date"><%= _.getDateText(date) %></span>\r\n</h3>\r\n<div class="content">\r\n    <p><%= answerText %></p>\r\n</div>\r\n<div class="hr"></div>';});
  ...
  define('views/TimelineAnswerView',['text!templates/timelineAnswerTpl.htm', 'backbone'], function(timelineAnswerTpl) {
    ...
    return TimelineAnswerView = (function(_super) {
      ...
      TimelineAnswerView.prototype.render = function() {
        ...
        this.$el.append(this.template(this.model.toJSON()[0]));
        return this;
      };
...
(function() {
  ...
  define('models/TimelinePostModel',['backbone'], function() {
    var TimelinePost;
    return TimelinePost = (function(_super) {
...
(function() {
  ...
  define('models/TimelineAnswerModel',['backbone'], function() {
    var TimelineAnswer;
    return TimelineAnswer = (function(_super) {
      __extends(TimelineAnswer, _super);

      function TimelineAnswer() {
        return TimelineAnswer.__super__.constructor.apply(this, arguments);
      }
    ...
    return TimelinePageView = (function(_super) {
      ...
      TimelinePageView.prototype.initialize = function() {
        ...
        return $.get('/statistic/get_user_notification', (function(_this) {
          return function(data) {
            var answers_timeline, new_answers;
            answers_timeline = typeof data.answers_timeline.result !== 'string' ? data.answers_timeline.result : {};
            new_answers = typeof data.new_answers.result !== 'string' ? data.new_answers.result : {};
            _this.answers = _.extend({}, answers_timeline, new_answers);
            _this.posts = data.posts_timeline.result;
            return _this.deferred.resolve();
          };
        })(this));
      };
      ...
      TimelinePageView.prototype.createPostsList = function() {
        return this.deferred.done((function(_this) {
          return function() {
            if (_this.posts.lentgh > 0) {
              _this.postsList = new TimelinePostsCollection(_this.posts);
              if (_this.timelinePostsList == null) {
                _this.timelinePostsList = new TimelinePostsList({
                  collection: _this.postsList
                });
              } else {
                _this.timelinePostsList.delegateEvents();
              }
              _this.$('#posts').append(_this.timelinePostsList.$el);
            } else {
              if (_this.postsEmptyView == null) {
                _this.postsEmptyView = new EmptyView({
                  message: 'Новых постов нет!'
                });
              } else {
                _this.postsEmptyView.delegateEvents();
              }
              _this.$('#posts').append(_this.postsEmptyView.render().$el);
            }
            return _this;
          };
        })(this));
      ...
      TimelinePageView.prototype.createAnswersList = function() {
        return this.deferred.done((function(_this) {
          return function() {
            if (_.size(_this.answers) > 0) {
              _this.answersList = new TimelineAnswersCollection(_this.answers);
              if (_this.timelineAnswersList == null) {
                _this.timelineAnswersList = new TimelineAnswersList({
                  collection: _this.answersList
                });
              } else {
                _this.timelineAnswersList.delegateEvents();
              }
              _this.$('#questions').append(_this.timelineAnswersList.$el);
            } else {
              if (_this.answersEmptyView == null) {
                _this.answersEmptyView = new EmptyView({
                  message: 'Новых ответов нет!'
                });
              } else {
                _this.answersEmptyView.delegateEvents();
              }
              _this.$('#questions').append(_this.answersEmptyView.render().$el);
            }
            return _this;
          };
        })(this));
...
(function() {
  define('admin/views/PostView',['text!admin/templates/postTpl.htm', 'backbone'], function(postTpl) {
    return Backbone.View.extend({
      ...
      setPostOfTheDay: function(event) {
        event.preventDefault();
  ...
  define('admin/collections/PostsCollection',['admin/models/PostModel', 'backbone'], function(PostModel) {
    return Backbone.Collection.extend({
      ...
      url: function() {
        ...
        return "/admin/get_posts/" + counter + "/10";
      }
    });
  });
...
(function() {
  define('admin/views/PostsList',['admin/views/PostsView', 'admin/collections/PostsCollection', 'backbone'], function(PostsView, PostsCollection) {
    return Backbone.View.extend({
      initialize: function() {
  ...
  define('admin/views/InterviewQuestionView',['text!admin/templates/interviewQuestionTpl.htm', 'backbone', 'stickit', 'mediator'], function(interviewQuestionTpl) {
    return Backbone.View.extend({
      ...
      deleteQuestion: function(event) {
        event.preventDefault();
        Backbone.Mediator.publish('question:removed', this.model);
...
(function() {
  define('admin/views/InterviewView',['text!admin/templates/interviewTpl.htm', 'admin/views/InterviewsQuestionsView', 'backbone', 'stickit'], function(interviewTpl, InterviewsQuestionsView) {
    return Backbone.View.extend({
      tagName: 'article',
      className: 'interview',
      template: _.template(interviewTpl),
      ...
      createInterviewsList: function() {
        if (this.interviewsQuestionView == null) {
          this.interviewsQuestionView = new InterviewsQuestionsView({
            collection: this.model.questions
          });
        } else {
          this.interviewsQuestionView.delegateEvents();
        }
        return this.$('#questionList').append(this.interviewsQuestionView.render().$el);
      },
...
(function() {
  define('admin/views/InterviewsView',['admin/views/InterviewView', 'backbone'], function(InterviewView) {
    return Backbone.View.extend({
      initialize: function() {
        this.collection.fetch();
        return this.listenTo(this.collection, 'add', this.addOne);
...
(function() {
  define('admin/models/InterviewQuestionModel',['backbone'], function() {
    return Backbone.Model.extend();
  });
...
(function() {
  define('admin/collections/InterviewsQuestionsCollection',['admin/models/InterviewQuestionModel', 'backbone'], function(InterviewQuestionModel) {
    return Backbone.Collection.extend({
...
(function() {
  define('nestCollection',['backbone'], function() {
...
(function() {
  ...
  define('admin/models/InterviewModel',['admin/collections/InterviewsQuestionsCollection', 'nestCollection', 'backbone'], function(InterviewsQuestionsCollection) {
    var InterviewModel;
    return InterviewModel = (function(_super) {
      ...
      InterviewModel.prototype.set = function(attributes, options) {
        var questions, ret;
        ret = Backbone.Model.prototype.set.call(this, attributes, options);
        if (attributes.questions) {
          questions = new InterviewsQuestionsCollection(this.get('questions'));
        } else {
          questions = new InterviewsQuestionsCollection();
        }
        this.questions = this.nestCollection('questions', questions);
        return ret;
      };
...
(function() {
  define('admin/views/InterviewsList',['admin/views/InterviewsView', 'admin/views/InterviewAddFormView', 'admin/collections/InterviewsCollection', 'admin/models/InterviewModel', 'backbone'], function(InterviewsView, InterviewAddFormView, InterviewsCollection, InterviewModel) {
    return Backbone.View.extend({
      ...
      events: function() {},
      createInterviewsList: function() {
        this.interviewsCollection = new InterviewsCollection();
        if (this.interviewsList == null) {
          this.interviewsList = new InterviewsView({
            collection: this.interviewsCollection
          });
        } else {
      ...
      createInterviewAddForm: function() {
      ...
      addInterview: function() {
        return this.interviewsCollection.add();
      }
    });
  });
...
(function() {
  ...
  define('admin/views/AdminPageView',['text!admin/templates/adminMainPageTpl.htm', 'admin/views/PostsList', 'admin/views/ContentsList', 'admin/views/InterviewsList', 'backbone', 'bootstrap'], function(adminMainPageTpl, PostsList, ContentsList, InterviewsList) {
    var AdminPageView;
