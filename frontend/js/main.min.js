...
(function() {
  ...
  define('views/StoriesPopUpView',['text!templates/storiesPopUpTpl.htm', 'views/PopUpView', 'views/ButtonsStoriesView', 'backbone'], function(storiesPopUpTpl, PopUpView, ButtonsStoriesView) {
...
define('text!admin/templates/legoTpl.htm',[],function () { return '';});


define('text!admin/templates/legoInterviewsTpl.htm',[],function () { return '<select>\n        <% _.each(interviews, function(interview) { %>\n        <%= legoInterviewTpl(interview.name) %>\n        <% }); %>\n</select>';});

(function() {
  var __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  define('admin/views/LegoInterviewsView',['text!admin/templates/legoInterviewsTpl.htm', 'backbone', 'stickit'], function(legoInterviewsTpl) {
    var LegoInterviewsView;
    return LegoInterviewsView = (function(_super) {
      __extends(LegoInterviewsView, _super);

      function LegoInterviewsView() {
        return LegoInterviewsView.__super__.constructor.apply(this, arguments);
      }

      LegoInterviewsView.prototype.tagName = 'article';

      LegoInterviewsView.prototype.template = _.template(legoInterviewsTpl);

      LegoInterviewsView.prototype.initialize = function(options) {
        return this.options = options || {};
      };

      LegoInterviewsView.prototype.render = function() {
        console.log(this.options);
        this.$el.append(this.template({
          interviews: this.options
        }));
        return this;
      };

      return LegoInterviewsView;
...
(function() {
  ...
  define('admin/views/LegoList',['text!admin/templates/legoTpl.htm', 'text!admin/templates/legoInterviewsTpl.htm', 'admin/views/LegoInterviewsView', 'backbone', 'stickit'], function(legoTpl, legoInterviewsTpl, LegoInterviewsView) {
    var LegoView;
    return LegoView = (function(_super) {
      ...
      LegoView.prototype.tagName = 'article';

      LegoView.prototype.className = 'interview';

      LegoView.prototype.template = _.template(legoTpl);

      LegoView.prototype.interviewTpl = _.template(legoInterviewsTpl);
      ...
      LegoView.prototype.getInterviewsList = function() {
        return $.post('/api/content/get_interviews_all', {}, (function(_this) {
          return function(data) {
            if (data) {
              return _this.$el.append(_this.template(_.extend({}, {
                interviewTpl: _this.interviewTpl(data)
              })));
            }
          };
        })(this));
...
(function() {
  ...
  define('admin/views/AdminPageView',['text!admin/templates/adminMainPageTpl.htm', 'admin/views/PostsList', 'admin/views/ContentsList', 'admin/views/InterviewsList', 'admin/views/PeoplesList', 'admin/views/LegoList', 'backbone', 'bootstrap'], function(adminMainPageTpl, PostsList, ContentsList, InterviewsList, PeoplesList, LegoList) {
    var AdminPageView;
    return AdminPageView = (function(_super) {
      ...
      AdminPageView.prototype.createLegoList = function() {
        if (this.legoList == null) {
          this.legoList = new LegoList();
        } else {
          this.legoList.delegateEvents();
        }
        this.$('#lego').append(this.legoList.$el);
        return this;
      };
