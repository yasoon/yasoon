 ...
 */
class AnswerEntity extends \Yasoon\Site\Entity\AnswerEntity implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'text', 'authorId', 'questionId', 'date', 'author', 'question');
    }
