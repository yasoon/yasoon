 ...
 */
class AuthorChangedPassEntity extends \Yasoon\Site\Entity\AuthorChangedPassEntity implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'authorId', 'last_date', 'author');
    }
